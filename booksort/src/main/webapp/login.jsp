...
<head>
    <title>登录页面</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/js/boot.css" />
...
<body>
<form action="<%=request.getContextPath()%>/emp/login" method="post" class="form-horizontal" role="form">
...
<%--    <div class="form-group">--%>
<%--        <div class="col-sm-offset-4 col-sm-8">--%>
<%--            <a href="<%=request.getContextPath()%>/e">没有账号？立马注册</a>--%>
<%--        </div>--%>
<%--    </div>--%>
</form>
</body>
